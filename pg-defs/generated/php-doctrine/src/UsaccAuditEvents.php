...
#[ORM\Entity]
#[ORM\Table(name: 'usacc_audit_events')]
class UsaccAuditEvents
{
    #[ORM\Id]
    ...
    #[ORM\Column(type: 'string', length: 96, name: 'event_type')]
    public string $eventType;

    #[ORM\Column(type: 'string', length: 128, name: 'event_hash')]
