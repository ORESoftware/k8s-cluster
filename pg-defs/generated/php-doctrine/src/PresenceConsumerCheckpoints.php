...
#[ORM\Entity]
#[ORM\Table(name: 'presence_consumer_checkpoints')]
class PresenceConsumerCheckpoints
{
    #[ORM\Id]
    #[ORM\GeneratedValue(strategy: 'NONE')]
    #[ORM\Column(type: 'text', name: 'consumer_id')]
    public string $consumerId;

    #[ORM\Column(type: 'bigint', name: 'last_seq')]
