...
type AccountsGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	Username string `gorm:"column:username;type:text;not null" json:"username"`
	AuthSecret string `gorm:"column:auth_secret;type:text;not null" json:"authSecret"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
}

func (AccountsGorm) TableName() string { return AccountsTable }

func (value AccountsGorm) Validate() error {
...
type DevicesGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	AccountId uuid.UUID `gorm:"column:account_id;type:uuid;not null" json:"accountId"`
	DeviceName string `gorm:"column:device_name;type:text;not null" json:"deviceName"`
	SyncTokenHash string `gorm:"column:sync_token_hash;type:text;not null" json:"syncTokenHash"`
	Revoked bool `gorm:"column:revoked;type:boolean;default:false;not null" json:"revoked"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
}

func (DevicesGorm) TableName() string { return DevicesTable }

func (value DevicesGorm) Validate() error {
...
type VaultBlobsGorm struct {
	AccountId uuid.UUID `gorm:"column:account_id;type:uuid;primaryKey" json:"accountId"`
	Ciphertext string `gorm:"column:ciphertext;type:text;not null" json:"ciphertext"`
	Nonce string `gorm:"column:nonce;type:text;not null" json:"nonce"`
	KdfSalt string `gorm:"column:kdf_salt;type:text;not null" json:"kdfSalt"`
	KdfParams datatypes.JSON `gorm:"column:kdf_params;type:jsonb;not null" json:"kdfParams"`
	Version datatypes.JSON `gorm:"column:version;type:jsonb;not null" json:"version"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
}

func (VaultBlobsGorm) TableName() string { return VaultBlobsTable }

func (value VaultBlobsGorm) Validate() error {
	if !validateJSONString(value.KdfParams) { return errors.New("vault_blobs.kdf_params must be valid JSON") }
	if !validateJSONString(value.Version) { return errors.New("vault_blobs.version must be valid JSON") }
	return nil
}
...
type DesSoccerTournamentsGorm struct {
	Id int64 `gorm:"column:id;type:bigserial;primaryKey" json:"id"`
	ExperimentId uuid.UUID `gorm:"column:experiment_id;type:uuid;not null" json:"experimentId"`
	TournamentDate string `gorm:"column:tournament_date;type:text;not null" json:"tournamentDate"`
	Seed int64 `gorm:"column:seed;type:bigint;not null" json:"seed"`
	LearningMode string `gorm:"column:learning_mode;type:text;not null" json:"learningMode"`
	Format datatypes.JSON `gorm:"column:format;type:jsonb;not null" json:"format"`
	TeamCount int32 `gorm:"column:team_count;type:integer;not null" json:"teamCount"`
	MatchCount int32 `gorm:"column:match_count;type:integer;default:0;not null" json:"matchCount"`
	MatchesPlayed int32 `gorm:"column:matches_played;type:integer;default:0;not null" json:"matchesPlayed"`
...
func (DesSoccerTournamentsGorm) TableName() string { return DesSoccerTournamentsTable }

func (value DesSoccerTournamentsGorm) Validate() error {
	if !validateJSONString(value.Format) { return errors.New("des_soccer_tournaments.format must be valid JSON") }
...
type DesSoccerTournamentMatchesGorm struct {
	...
	AwayTeamId int32 `gorm:"column:away_team_id;type:integer;not null" json:"awayTeamId"`
	HomeGoals int32 `gorm:"column:home_goals;type:integer;not null" json:"homeGoals"`
	AwayGoals int32 `gorm:"column:away_goals;type:integer;not null" json:"awayGoals"`
	ShootoutWinnerTeamId *int32 `gorm:"column:shootout_winner_team_id;type:integer" json:"shootoutWinnerTeamId,omitempty"`
	HomeTrainingSteps int64 `gorm:"column:home_training_steps;type:bigint;not null" json:"homeTrainingSteps"`
	AwayTrainingSteps int64 `gorm:"column:away_training_steps;type:bigint;not null" json:"awayTrainingSteps"`
	RecordedAt time.Time `gorm:"column:recorded_at;type:timestamptz;default:now();not null" json:"recordedAt"`
}

func (DesSoccerTournamentMatchesGorm) TableName() string { return DesSoccerTournamentMatchesTable }

func (value DesSoccerTournamentMatchesGorm) Validate() error {
	return nil
}
...
type DesSoccerTournamentTeamBrainsGorm struct {
	...
	Seed int64 `gorm:"column:seed;type:bigint;not null" json:"seed"`
	MatchesLearned int32 `gorm:"column:matches_learned;type:integer;not null" json:"matchesLearned"`
	TrainingSteps int64 `gorm:"column:training_steps;type:bigint;not null" json:"trainingSteps"`
	Played int32 `gorm:"column:played;type:integer;not null" json:"played"`
	Wins int32 `gorm:"column:wins;type:integer;not null" json:"wins"`
	Draws int32 `gorm:"column:draws;type:integer;not null" json:"draws"`
	Losses int32 `gorm:"column:losses;type:integer;not null" json:"losses"`
	GoalsFor int32 `gorm:"column:goals_for;type:integer;not null" json:"goalsFor"`
	GoalsAgainst int32 `gorm:"column:goals_against;type:integer;not null" json:"goalsAgainst"`
	NeuralSnapshot *datatypes.JSON `gorm:"column:neural_snapshot;type:jsonb" json:"neuralSnapshot,omitempty"`
	Genome *datatypes.JSON `gorm:"column:genome;type:jsonb" json:"genome,omitempty"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
}

func (DesSoccerTournamentTeamBrainsGorm) TableName() string { return DesSoccerTournamentTeamBrainsTable }

func (value DesSoccerTournamentTeamBrainsGorm) Validate() error {
	if value.NeuralSnapshot != nil {
		if !validateJSONString(*value.NeuralSnapshot) { return errors.New("des_soccer_tournament_team_brains.neural_snapshot must be valid JSON") }
	}
	if value.Genome != nil {
		if !validateJSONString(*value.Genome) { return errors.New("des_soccer_tournament_team_brains.genome must be valid JSON") }
	}
	return nil
}
...
type DesSoccerLearningSetPlayRunsGorm struct {
	RunId uuid.UUID `gorm:"column:run_id;type:uuid;primaryKey" json:"runId"`
	PolicyVersionId uuid.UUID `gorm:"column:policy_version_id;type:uuid;not null" json:"policyVersionId"`
	PrimaryRestart string `gorm:"column:primary_restart;type:varchar(40);not null" json:"primaryRestart"`
	Team string `gorm:"column:team;type:varchar(8);not null" json:"team"`
	SpotXMicros int64 `gorm:"column:spot_x_micros;type:bigint;not null" json:"spotXMicros"`
	SpotYMicros int64 `gorm:"column:spot_y_micros;type:bigint;not null" json:"spotYMicros"`
	DurationSecondsMicros int64 `gorm:"column:duration_seconds_micros;type:bigint;not null" json:"durationSecondsMicros"`
	EpisodeCount int32 `gorm:"column:episode_count;type:integer;not null" json:"episodeCount"`
	Goals int32 `gorm:"column:goals;type:integer;not null" json:"goals"`
	GoalRateMicros int64 `gorm:"column:goal_rate_micros;type:bigint;not null" json:"goalRateMicros"`
	FirstWindowGoalRateMicros int64 `gorm:"column:first_window_goal_rate_micros;type:bigint;not null" json:"firstWindowGoalRateMicros"`
	LastWindowGoalRateMicros int64 `gorm:"column:last_window_goal_rate_micros;type:bigint;not null" json:"lastWindowGoalRateMicros"`
	GoalRateDeltaMicros int64 `gorm:"column:goal_rate_delta_micros;type:bigint;not null" json:"goalRateDeltaMicros"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
}

func (DesSoccerLearningSetPlayRunsGorm) TableName() string { return DesSoccerLearningSetPlayRunsTable }

func (value DesSoccerLearningSetPlayRunsGorm) Validate() error {
...
func (DesSoccerLearningSetPlayRestartMixGorm) TableName() string { return DesSoccerLearningSetPlayRestartMixTable }

func (value DesSoccerLearningSetPlayRestartMixGorm) Validate() error {
...
type DesSoccerLearningSetPlayEpisodeMetricsGorm struct {
	...
	Scored bool `gorm:"column:scored;type:boolean;not null" json:"scored"`
	ScoreDeltaForTeam int32 `gorm:"column:score_delta_for_team;type:integer;not null" json:"scoreDeltaForTeam"`
	Ticks int64 `gorm:"column:ticks;type:bigint;not null" json:"ticks"`
	SimulatedSecondsMicros int64 `gorm:"column:simulated_seconds_micros;type:bigint;not null" json:"simulatedSecondsMicros"`
	PolicyUpdates int64 `gorm:"column:policy_updates;type:bigint;not null" json:"policyUpdates"`
	HomePolicyEntries int32 `gorm:"column:home_policy_entries;type:integer;not null" json:"homePolicyEntries"`
	HomePolicyTargetEntries int32 `gorm:"column:home_policy_target_entries;type:integer;not null" json:"homePolicyTargetEntries"`
	AwayPolicyEntries int32 `gorm:"column:away_policy_entries;type:integer;not null" json:"awayPolicyEntries"`
	AwayPolicyTargetEntries int32 `gorm:"column:away_policy_target_entries;type:integer;not null" json:"awayPolicyTargetEntries"`
	NeuralTrainingSteps int32 `gorm:"column:neural_training_steps;type:integer;not null" json:"neuralTrainingSteps"`
	NeuralSamples int64 `gorm:"column:neural_samples;type:bigint;not null" json:"neuralSamples"`
	NeuralReplaySamples int32 `gorm:"column:neural_replay_samples;type:integer;not null" json:"neuralReplaySamples"`
	NeuralLastLossMicros *int64 `gorm:"column:neural_last_loss_micros;type:bigint" json:"neuralLastLossMicros,omitempty"`
	CumulativeGoals int32 `gorm:"column:cumulative_goals;type:integer;not null" json:"cumulativeGoals"`
	GoalRateSoFarMicros int64 `gorm:"column:goal_rate_so_far_micros;type:bigint;not null" json:"goalRateSoFarMicros"`
}

func (DesSoccerLearningSetPlayEpisodeMetricsGorm) TableName() string { return DesSoccerLearningSetPlayEpisodeMetricsTable }

func (value DesSoccerLearningSetPlayEpisodeMetricsGorm) Validate() error {
...
type DesSoccerLearningNeuralRunMetricsGorm struct {
	RunId uuid.UUID `gorm:"column:run_id;type:uuid;primaryKey" json:"runId"`
	PolicyVersionId uuid.UUID `gorm:"column:policy_version_id;type:uuid;not null" json:"policyVersionId"`
	...
	TrainingSteps int32 `gorm:"column:training_steps;type:integer;not null" json:"trainingSteps"`
	Samples int64 `gorm:"column:samples;type:bigint;not null" json:"samples"`
	PendingBatches int32 `gorm:"column:pending_batches;type:integer;not null" json:"pendingBatches"`
	DroppedBatches int32 `gorm:"column:dropped_batches;type:integer;not null" json:"droppedBatches"`
	ReplaySamples int32 `gorm:"column:replay_samples;type:integer;not null" json:"replaySamples"`
	ReplayCapacity int32 `gorm:"column:replay_capacity;type:integer;not null" json:"replayCapacity"`
	ParameterCount int32 `gorm:"column:parameter_count;type:integer;not null" json:"parameterCount"`
	TargetClipMicros int64 `gorm:"column:target_clip_micros;type:bigint;not null" json:"targetClipMicros"`
	LastLossMicros *int64 `gorm:"column:last_loss_micros;type:bigint" json:"lastLossMicros,omitempty"`
	AverageLossMicros *int64 `gorm:"column:average_loss_micros;type:bigint" json:"averageLossMicros,omitempty"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
}

func (DesSoccerLearningNeuralRunMetricsGorm) TableName() string { return DesSoccerLearningNeuralRunMetricsTable }

func (value DesSoccerLearningNeuralRunMetricsGorm) Validate() error {
...
type BenefactorMarketingPortalMembersGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	ClientId uuid.UUID `gorm:"column:client_id;type:uuid;not null" json:"clientId"`
	ContactId *uuid.UUID `gorm:"column:contact_id;type:uuid" json:"contactId,omitempty"`
	UserId *uuid.UUID `gorm:"column:user_id;type:uuid" json:"userId,omitempty"`
	Email string `gorm:"column:email;type:varchar(240);not null" json:"email"`
	Status string `gorm:"column:status;type:varchar(32);default:'invited';not null" json:"status"`
	Role string `gorm:"column:role;type:varchar(32);default:'viewer';not null" json:"role"`
	AccessScope datatypes.JSON `gorm:"column:access_scope;type:jsonb;default:'{}'::jsonb;not null" json:"accessScope"`
	LastSeenAt *time.Time `gorm:"column:last_seen_at;type:timestamptz" json:"lastSeenAt,omitempty"`
	InvitedAt time.Time `gorm:"column:invited_at;type:timestamptz;default:now();not null" json:"invitedAt"`
	AcceptedAt *time.Time `gorm:"column:accepted_at;type:timestamptz" json:"acceptedAt,omitempty"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
}

func (BenefactorMarketingPortalMembersGorm) TableName() string { return BenefactorMarketingPortalMembersTable }

func (value BenefactorMarketingPortalMembersGorm) Validate() error {
	...
	if !validateJSONString(value.AccessScope) { return errors.New("benefactor_marketing_portal_members.access_scope must be valid JSON") }
	return nil
}
...
type BenefactorMarketingSharedDocumentsGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	ClientId uuid.UUID `gorm:"column:client_id;type:uuid;not null" json:"clientId"`
	CampaignId *uuid.UUID `gorm:"column:campaign_id;type:uuid" json:"campaignId,omitempty"`
	ContentAssetId *uuid.UUID `gorm:"column:content_asset_id;type:uuid" json:"contentAssetId,omitempty"`
	Status string `gorm:"column:status;type:varchar(32);default:'active';not null" json:"status"`
	DocumentKind string `gorm:"column:document_kind;type:varchar(48);not null" json:"documentKind"`
	Title string `gorm:"column:title;type:varchar(240);not null" json:"title"`
	StorageUri string `gorm:"column:storage_uri;type:text;not null" json:"storageUri"`
	MimeType *string `gorm:"column:mime_type;type:varchar(120)" json:"mimeType,omitempty"`
	Visibility string `gorm:"column:visibility;type:varchar(32);default:'client_portal';not null" json:"visibility"`
	UploadedBy *uuid.UUID `gorm:"column:uploaded_by;type:uuid" json:"uploadedBy,omitempty"`
	MetaData datatypes.JSON `gorm:"column:meta_data;type:jsonb;default:'{}'::jsonb;not null" json:"metaData"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
}

func (BenefactorMarketingSharedDocumentsGorm) TableName() string { return BenefactorMarketingSharedDocumentsTable }

func (value BenefactorMarketingSharedDocumentsGorm) Validate() error {
	...
	if !validateJSONString(value.MetaData) { return errors.New("benefactor_marketing_shared_documents.meta_data must be valid JSON") }
	return nil
}
...
type BenefactorMarketingCollaborationCommentsGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	ClientId uuid.UUID `gorm:"column:client_id;type:uuid;not null" json:"clientId"`
	ParentCommentId *uuid.UUID `gorm:"column:parent_comment_id;type:uuid" json:"parentCommentId,omitempty"`
	ResourceType string `gorm:"column:resource_type;type:varchar(64);not null" json:"resourceType"`
	ResourceId *uuid.UUID `gorm:"column:resource_id;type:uuid" json:"resourceId,omitempty"`
	AuthorUserId *uuid.UUID `gorm:"column:author_user_id;type:uuid" json:"authorUserId,omitempty"`
	AuthorContactId *uuid.UUID `gorm:"column:author_contact_id;type:uuid" json:"authorContactId,omitempty"`
...
func (BenefactorMarketingCollaborationCommentsGorm) TableName() string { return BenefactorMarketingCollaborationCommentsTable }

func (value BenefactorMarketingCollaborationCommentsGorm) Validate() error {
	...
	if !validateJSONString(value.MetaData) { return errors.New("benefactor_marketing_collaboration_comments.meta_data must be valid JSON") }
	return nil
}
...
type BenefactorMarketingNotificationsGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	ClientId uuid.UUID `gorm:"column:client_id;type:uuid;not null" json:"clientId"`
	RecipientUserId *uuid.UUID `gorm:"column:recipient_user_id;type:uuid" json:"recipientUserId,omitempty"`
	RecipientContactId *uuid.UUID `gorm:"column:recipient_contact_id;type:uuid" json:"recipientContactId,omitempty"`
	Channel string `gorm:"column:channel;type:varchar(32);default:'email';not null" json:"channel"`
	Status string `gorm:"column:status;type:varchar(32);default:'queued';not null" json:"status"`
	NotificationKind string `gorm:"column:notification_kind;type:varchar(64);not null" json:"notificationKind"`
	Title string `gorm:"column:title;type:varchar(240);not null" json:"title"`
	Body *string `gorm:"column:body;type:text" json:"body,omitempty"`
	Payload datatypes.JSON `gorm:"column:payload;type:jsonb;default:'{}'::jsonb;not null" json:"payload"`
...
func (BenefactorMarketingNotificationsGorm) TableName() string { return BenefactorMarketingNotificationsTable }

func (value BenefactorMarketingNotificationsGorm) Validate() error {
	...
	if !validateJSONString(value.Payload) { return errors.New("benefactor_marketing_notifications.payload must be valid JSON") }
	return nil
}
...
type BenefactorMarketingTimeEntriesGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	ClientId *uuid.UUID `gorm:"column:client_id;type:uuid" json:"clientId,omitempty"`
	CampaignId *uuid.UUID `gorm:"column:campaign_id;type:uuid" json:"campaignId,omitempty"`
	ProjectTaskId *uuid.UUID `gorm:"column:project_task_id;type:uuid" json:"projectTaskId,omitempty"`
	UserId uuid.UUID `gorm:"column:user_id;type:uuid;not null" json:"userId"`
	EntryDate string `gorm:"column:entry_date;type:varchar(10);not null" json:"entryDate"`
	Minutes int32 `gorm:"column:minutes;type:integer;not null" json:"minutes"`
	Billable bool `gorm:"column:billable;type:boolean;default:true;not null" json:"billable"`
	RateCents int32 `gorm:"column:rate_cents;type:integer;default:0;not null" json:"rateCents"`
	CostCents int32 `gorm:"column:cost_cents;type:integer;default:0;not null" json:"costCents"`
	Notes *string `gorm:"column:notes;type:text" json:"notes,omitempty"`
	MetaData datatypes.JSON `gorm:"column:meta_data;type:jsonb;default:'{}'::jsonb;not null" json:"metaData"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
...
func (BenefactorMarketingTimeEntriesGorm) TableName() string { return BenefactorMarketingTimeEntriesTable }

func (value BenefactorMarketingTimeEntriesGorm) Validate() error {
	...
	if !validateJSONString(value.MetaData) { return errors.New("benefactor_marketing_time_entries.meta_data must be valid JSON") }
	return nil
}
...
type BenefactorMarketingVendorCostsGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	ClientId *uuid.UUID `gorm:"column:client_id;type:uuid" json:"clientId,omitempty"`
	CampaignId *uuid.UUID `gorm:"column:campaign_id;type:uuid" json:"campaignId,omitempty"`
	VendorName string `gorm:"column:vendor_name;type:varchar(200);not null" json:"vendorName"`
	Category string `gorm:"column:category;type:varchar(64);not null" json:"category"`
	Status string `gorm:"column:status;type:varchar(32);default:'planned';not null" json:"status"`
	AmountCents int32 `gorm:"column:amount_cents;type:integer;not null" json:"amountCents"`
	IncurredOn *string `gorm:"column:incurred_on;type:varchar(10)" json:"incurredOn,omitempty"`
	InvoiceRef *string `gorm:"column:invoice_ref;type:varchar(120)" json:"invoiceRef,omitempty"`
	MetaData datatypes.JSON `gorm:"column:meta_data;type:jsonb;default:'{}'::jsonb;not null" json:"metaData"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
}

func (BenefactorMarketingVendorCostsGorm) TableName() string { return BenefactorMarketingVendorCostsTable }

func (value BenefactorMarketingVendorCostsGorm) Validate() error {
	...
	if !validateJSONString(value.MetaData) { return errors.New("benefactor_marketing_vendor_costs.meta_data must be valid JSON") }
	return nil
}
...
type BenefactorMarketingCommissionEntriesGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	ClientId *uuid.UUID `gorm:"column:client_id;type:uuid" json:"clientId,omitempty"`
	OpportunityId *uuid.UUID `gorm:"column:opportunity_id;type:uuid" json:"opportunityId,omitempty"`
	UserId uuid.UUID `gorm:"column:user_id;type:uuid;not null" json:"userId"`
	Status string `gorm:"column:status;type:varchar(32);default:'pending';not null" json:"status"`
	CommissionKind string `gorm:"column:commission_kind;type:varchar(48);default:'deal';not null" json:"commissionKind"`
	BasisCents int32 `gorm:"column:basis_cents;type:integer;default:0;not null" json:"basisCents"`
	RateMicros int32 `gorm:"column:rate_micros;type:integer;default:0;not null" json:"rateMicros"`
	AmountCents int32 `gorm:"column:amount_cents;type:integer;default:0;not null" json:"amountCents"`
	EarnedOn *string `gorm:"column:earned_on;type:varchar(10)" json:"earnedOn,omitempty"`
	PaidAt *time.Time `gorm:"column:paid_at;type:timestamptz" json:"paidAt,omitempty"`
	MetaData datatypes.JSON `gorm:"column:meta_data;type:jsonb;default:'{}'::jsonb;not null" json:"metaData"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
...
func (BenefactorMarketingCommissionEntriesGorm) TableName() string { return BenefactorMarketingCommissionEntriesTable }

func (value BenefactorMarketingCommissionEntriesGorm) Validate() error {
	...
	if !validateJSONString(value.MetaData) { return errors.New("benefactor_marketing_commission_entries.meta_data must be valid JSON") }
	return nil
}
...
type BenefactorMarketingBudgetForecastsGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	ClientId uuid.UUID `gorm:"column:client_id;type:uuid;not null" json:"clientId"`
	CampaignId *uuid.UUID `gorm:"column:campaign_id;type:uuid" json:"campaignId,omitempty"`
	ForecastKind string `gorm:"column:forecast_kind;type:varchar(48);default:'monthly';not null" json:"forecastKind"`
	PeriodStart string `gorm:"column:period_start;type:varchar(10);not null" json:"periodStart"`
	PeriodEnd string `gorm:"column:period_end;type:varchar(10);not null" json:"periodEnd"`
	Status string `gorm:"column:status;type:varchar(32);default:'draft';not null" json:"status"`
	RevenueCents int32 `gorm:"column:revenue_cents;type:integer;default:0;not null" json:"revenueCents"`
	MediaSpendCents int32 `gorm:"column:media_spend_cents;type:integer;default:0;not null" json:"mediaSpendCents"`
	LaborCostCents int32 `gorm:"column:labor_cost_cents;type:integer;default:0;not null" json:"laborCostCents"`
	VendorCostCents int32 `gorm:"column:vendor_cost_cents;type:integer;default:0;not null" json:"vendorCostCents"`
	GrossMarginCents int32 `gorm:"column:gross_margin_cents;type:integer;default:0;not null" json:"grossMarginCents"`
	Assumptions datatypes.JSON `gorm:"column:assumptions;type:jsonb;default:'{}'::jsonb;not null" json:"assumptions"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
}

func (BenefactorMarketingBudgetForecastsGorm) TableName() string { return BenefactorMarketingBudgetForecastsTable }

func (value BenefactorMarketingBudgetForecastsGorm) Validate() error {
	...
	if !validateJSONString(value.Assumptions) { return errors.New("benefactor_marketing_budget_forecasts.assumptions must be valid JSON") }
	return nil
}
...
type BenefactorMarketingCallInsightsGorm struct {
	Id uuid.UUID `gorm:"column:id;type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	ClientId uuid.UUID `gorm:"column:client_id;type:uuid;not null" json:"clientId"`
	MeetingId *uuid.UUID `gorm:"column:meeting_id;type:uuid" json:"meetingId,omitempty"`
	LeadId *uuid.UUID `gorm:"column:lead_id;type:uuid" json:"leadId,omitempty"`
	OpportunityId *uuid.UUID `gorm:"column:opportunity_id;type:uuid" json:"opportunityId,omitempty"`
	Status string `gorm:"column:status;type:varchar(32);default:'ready';not null" json:"status"`
	Provider *string `gorm:"column:provider;type:varchar(64)" json:"provider,omitempty"`
	TranscriptUri *string `gorm:"column:transcript_uri;type:text" json:"transcriptUri,omitempty"`
	Summary *string `gorm:"column:summary;type:text" json:"summary,omitempty"`
	Sentiment *string `gorm:"column:sentiment;type:varchar(32)" json:"sentiment,omitempty"`
	ActionItems datatypes.JSON `gorm:"column:action_items;type:jsonb;default:'[]'::jsonb;not null" json:"actionItems"`
	Objections datatypes.JSON `gorm:"column:objections;type:jsonb;default:'[]'::jsonb;not null" json:"objections"`
	NextSteps datatypes.JSON `gorm:"column:next_steps;type:jsonb;default:'[]'::jsonb;not null" json:"nextSteps"`
	ConfidenceMicros int32 `gorm:"column:confidence_micros;type:integer;default:0;not null" json:"confidenceMicros"`
	AnalyzedAt time.Time `gorm:"column:analyzed_at;type:timestamptz;default:now();not null" json:"analyzedAt"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
}

func (BenefactorMarketingCallInsightsGorm) TableName() string { return BenefactorMarketingCallInsightsTable }

func (value BenefactorMarketingCallInsightsGorm) Validate() error {
	...
	if !validateJSONString(value.ActionItems) { return errors.New("benefactor_marketing_call_insights.action_items must be valid JSON") }
	if !validateJSONString(value.Objections) { return errors.New("benefactor_marketing_call_insights.objections must be valid JSON") }
...
type SessionsGorm struct {
	...
	ProviderTenant string `gorm:"column:provider_tenant;type:text;default:'default';not null" json:"providerTenant"`
	ProviderSubject string `gorm:"column:provider_subject;type:text;not null" json:"providerSubject"`
	AuthLevel string `gorm:"column:auth_level;type:smallint;default:1;not null" json:"authLevel"`
	AuthMethods datatypes.JSON `gorm:"column:auth_methods;type:jsonb;default:'[]'::jsonb;not null" json:"authMethods"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	UpdatedAt time.Time `gorm:"column:updated_at;type:timestamptz;default:now();not null" json:"updatedAt"`
	LastSeenAt time.Time `gorm:"column:last_seen_at;type:timestamptz;default:now();not null" json:"lastSeenAt"`
	ExpiresAt time.Time `gorm:"column:expires_at;type:timestamptz;not null" json:"expiresAt"`
...
func (value SessionsGorm) Validate() error {
	...
	if !validateJSONString(value.AuthMethods) { return errors.New("sessions.auth_methods must be valid JSON") }
	return nil
}
...
type MagicLinkTokensGorm struct {
	TokenHash string `gorm:"column:token_hash;type:text;primaryKey" json:"tokenHash"`
	OtpHash string `gorm:"column:otp_hash;type:text;not null" json:"otpHash"`
	SharedUserId uuid.UUID `gorm:"column:shared_user_id;type:uuid;not null" json:"sharedUserId"`
	IdentifierHash string `gorm:"column:identifier_hash;type:text;not null" json:"identifierHash"`
	FailedAttempts int32 `gorm:"column:failed_attempts;type:integer;default:0;not null" json:"failedAttempts"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	ExpiresAt time.Time `gorm:"column:expires_at;type:timestamptz;not null" json:"expiresAt"`
	ConsumedAt *time.Time `gorm:"column:consumed_at;type:timestamptz" json:"consumedAt,omitempty"`
...
func (MagicLinkTokensGorm) TableName() string { return MagicLinkTokensTable }

func (value MagicLinkTokensGorm) Validate() error {
...
type MfaSmsChallengesGorm struct {
	ChallengeId uuid.UUID `gorm:"column:challenge_id;type:uuid;primaryKey;default:gen_random_uuid()" json:"challengeId"`
	SharedUserId uuid.UUID `gorm:"column:shared_user_id;type:uuid;not null" json:"sharedUserId"`
	PhoneE164 string `gorm:"column:phone_e164;type:text;not null" json:"phoneE164"`
	CreatedAt time.Time `gorm:"column:created_at;type:timestamptz;default:now();not null" json:"createdAt"`
	ExpiresAt time.Time `gorm:"column:expires_at;type:timestamptz;not null" json:"expiresAt"`
	VerifiedAt *time.Time `gorm:"column:verified_at;type:timestamptz" json:"verifiedAt,omitempty"`
}

func (MfaSmsChallengesGorm) TableName() string { return MfaSmsChallengesTable }

func (value MfaSmsChallengesGorm) Validate() error {
