...
@Entity
@Table(name = "benefactor_marketing_content_assets")
public class BenefactorMarketingContentAssetsEntity {
    @Id
    @Column(name = "id")
    private UUID id;
    ...
    @Column(name = "asset_kind", length = 48, nullable = false)
    private String assetKind;

    @Column(name = "title", length = 240, nullable = false)
    private String title;

    @Column(name = "channel", length = 64, nullable = true)
    private String channel;

    @Column(name = "body", nullable = true)
    private String body;

    @Column(name = "asset_uri", nullable = true)
    private String assetUri;

    @Column(name = "seo_keywords", nullable = false, columnDefinition = "jsonb")
    private String seoKeywords;

    @Column(name = "approval_status", length = 32, nullable = false)
    private String approvalStatus;

    @Column(name = "publish_at", nullable = true, columnDefinition = "timestamptz")
