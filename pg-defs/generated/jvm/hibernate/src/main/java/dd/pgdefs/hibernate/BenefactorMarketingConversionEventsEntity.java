...
@Entity
@Table(name = "benefactor_marketing_conversion_events")
public class BenefactorMarketingConversionEventsEntity {
    @Id
    @Column(name = "id")
    private UUID id;
    ...
    @Column(name = "visitor_key", length = 200, nullable = true)
