...
diesel::table! {
    ...
    des_soccer_tournaments (id) {
        ...
        wall_time_seconds -> Nullable<Double>,
        status -> Text,
        created_at -> Timestamptz,
        updated_at -> Timestamptz,
        finished_at -> Nullable<Timestamptz>,
...
diesel::table! {
    ...
    benefactor_leads (id) {
        ...
        country -> Varchar,
        service_area -> Nullable<Varchar>,
        lead_status -> Varchar,
        outreach_status -> Varchar,
        total_outreach_attempts -> Int4,
        last_outreach_at -> Nullable<Timestamptz>,
        contact_attempts -> Jsonb,
        source_url -> Nullable<Varchar>,
        source_query -> Nullable<Varchar>,
        source_tool -> Nullable<Varchar>,
        source_engine -> Nullable<Varchar>,
        is_verified -> Bool,
        tags -> Jsonb,
        meta_data -> Jsonb,
        notes -> Nullable<Text>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = benefactor_leads)]
pub struct BenefactorLeadsDieselRow {
    pub id: Uuid,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = benefactor_leads)]
pub struct BenefactorLeadsDieselInsert {
    pub id: Option<Uuid>,
...
diesel::table! {
    ...
    benefactor_leads_domains (id) {
        ...
        skip_until -> Nullable<Timestamptz>,
        scrape_count -> Int4,
        skip_count -> Int4,
        skipped_count -> Int4,
        email_found_count -> Int4,
        lead_inserted_count -> Int4,
        last_seen_at -> Nullable<Timestamptz>,
        last_scraped_at -> Nullable<Timestamptz>,
        last_skipped_at -> Nullable<Timestamptz>,
        last_email_found_at -> Nullable<Timestamptz>,
        last_lead_inserted_at -> Nullable<Timestamptz>,
        last_seen_url -> Nullable<Text>,
        meta_data -> Jsonb,
        is_active -> Bool,
        is_soft_deleted -> Bool,
        created_at -> Timestamptz,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = benefactor_leads_domains)]
pub struct BenefactorLeadsDomainsDieselRow {
    pub id: Uuid,
    pub domain: String,
    ...
    pub last_email_found_at: Option<DateTime<Utc>>,
    pub last_lead_inserted_at: Option<DateTime<Utc>>,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = benefactor_leads_domains)]
pub struct BenefactorLeadsDomainsDieselInsert {
    pub id: Option<Uuid>,
    pub domain: Option<String>,
...
diesel::table! {
    use diesel::sql_types::*;
    benefactor_search_locations (id) {
        id -> Uuid,
        slug -> Varchar,
        city -> Varchar,
        state -> Varchar,
        state_code -> Nullable<Varchar>,
        country -> Varchar,
        metro_area -> Nullable<Varchar>,
        military_area -> Nullable<Varchar>,
        primary_installation -> Nullable<Varchar>,
        installation_aliases -> Jsonb,
        location_type -> Varchar,
        priority -> Int4,
        search_weight -> Int4,
        total_query_runs -> Int4,
        total_emails_inserted -> Int4,
        success_count -> Int4,
        failure_count -> Int4,
        last_run_at -> Nullable<Timestamptz>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = benefactor_search_locations)]
pub struct BenefactorSearchLocationsDieselRow {
    pub id: Uuid,
    pub slug: String,
    pub city: String,
    pub state: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = benefactor_search_locations)]
pub struct BenefactorSearchLocationsDieselInsert {
    pub id: Option<Uuid>,
    pub slug: Option<String>,
    pub city: Option<String>,
    pub state: Option<String>,
...
diesel::table! {
    use diesel::sql_types::*;
    benefactor_scrape_queries (id) {
        id -> Uuid,
        query_text -> Text,
        query_hash -> Varchar,
        benefactor_icp_slug -> Nullable<Varchar>,
        benefactor_icp_name -> Nullable<Varchar>,
        benefactor_search_location_id -> Nullable<Uuid>,
        service_category -> Varchar,
        target_city -> Nullable<Varchar>,
        target_state -> Nullable<Varchar>,
        target_country -> Varchar,
        target_military_area -> Nullable<Varchar>,
        target_installation -> Nullable<Varchar>,
        query_variant -> Varchar,
        search_page_depth -> Int4,
        priority -> Int4,
        total_runs -> Int4,
        total_urls_visited -> Int4,
        total_emails_found -> Int4,
        total_emails_inserted -> Int4,
        total_emails_duplicate -> Int4,
        total_errors -> Int4,
        success_count -> Int4,
        failure_count -> Int4,
        last_run_at -> Nullable<Timestamptz>,
        last_success_at -> Nullable<Timestamptz>,
        last_failure_at -> Nullable<Timestamptz>,
        last_run_emails_found -> Int4,
        last_run_emails_inserted -> Int4,
        last_run_success -> Bool,
        last_run_duration_ms -> Int4,
        last_run_error -> Nullable<Text>,
        cooldown_until -> Nullable<Timestamptz>,
        consecutive_zero_new_runs -> Int4,
        last_zero_new_run_at -> Nullable<Timestamptz>,
        meta_data -> Jsonb,
        is_active -> Bool,
        is_soft_deleted -> Bool,
        created_at -> Timestamptz,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = benefactor_scrape_queries)]
pub struct BenefactorScrapeQueriesDieselRow {
    pub id: Uuid,
    ...
    pub last_zero_new_run_at: Option<DateTime<Utc>>,
    pub meta_data: Value,
    pub is_active: bool,
    pub is_soft_deleted: bool,
    pub created_at: DateTime<Utc>,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = benefactor_scrape_queries)]
pub struct BenefactorScrapeQueriesDieselInsert {
    pub id: Option<Uuid>,
...
diesel::table! {
    use diesel::sql_types::*;
    benefactor_domain_search_tracking (id) {
        id -> Uuid,
        domain -> Varchar,
        for_what -> Varchar,
        search_result_appearances -> Int4,
        queued_visit_count -> Int4,
        visit_count -> Int4,
        good_result_count -> Int4,
        bad_result_count -> Int4,
        email_found_count -> Int4,
        lead_inserted_count -> Int4,
        last_queued_at -> Nullable<Timestamptz>,
        last_visited_at -> Nullable<Timestamptz>,
        last_good_result_at -> Nullable<Timestamptz>,
        last_bad_result_at -> Nullable<Timestamptz>,
        last_email_found_at -> Nullable<Timestamptz>,
        last_lead_inserted_at -> Nullable<Timestamptz>,
        last_good_url -> Nullable<Text>,
        last_bad_url -> Nullable<Text>,
        blocked_until -> Nullable<Timestamptz>,
        is_permanently_blocked -> Bool,
        blocked_reason -> Nullable<Text>,
        meta_data -> Jsonb,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = benefactor_domain_search_tracking)]
pub struct BenefactorDomainSearchTrackingDieselRow {
    pub id: Uuid,
    pub domain: String,
    pub for_what: String,
    ...
    pub last_good_result_at: Option<DateTime<Utc>>,
    pub last_bad_result_at: Option<DateTime<Utc>>,
    pub last_email_found_at: Option<DateTime<Utc>>,
    pub last_lead_inserted_at: Option<DateTime<Utc>>,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = benefactor_domain_search_tracking)]
pub struct BenefactorDomainSearchTrackingDieselInsert {
    pub id: Option<Uuid>,
    pub domain: Option<String>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = benefactor_icps)]
pub struct BenefactorIcpsDieselRow {
    pub id: Uuid,
    pub slug: String,
    pub name: String,
    pub category: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = benefactor_icps)]
pub struct BenefactorIcpsDieselInsert {
    pub id: Option<Uuid>,
    pub slug: Option<String>,
    pub name: Option<String>,
    pub category: Option<String>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = sync_clock)]
pub struct SyncClockDieselRow {
    pub singleton: bool,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = sync_clock)]
pub struct SyncClockDieselInsert {
...
pub struct SyncTombstonesDieselRow {
    pub sequence: i64,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = sync_tombstones)]
pub struct SyncTombstonesDieselInsert {
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = projects)]
pub struct ProjectsDieselInsert {
    pub id: Option<Uuid>,
...
pub struct OrgMembersDieselRow {
    pub org_id: Uuid,
    pub user_id: Uuid,
    pub role: String,
    pub created_at: DateTime<Utc>,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = org_members)]
pub struct OrgMembersDieselInsert {
    pub org_id: Option<Uuid>,
    pub user_id: Option<Uuid>,
    pub role: Option<String>,
    pub created_at: Option<DateTime<Utc>>,
...
pub struct ProjectMembersDieselRow {
    pub project_id: Uuid,
    pub user_id: Uuid,
    pub role: String,
    pub created_at: DateTime<Utc>,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = project_members)]
pub struct ProjectMembersDieselInsert {
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = api_keys)]
pub struct ApiKeysDieselInsert {
    pub id: Option<Uuid>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = mtls_client_certs)]
pub struct MtlsClientCertsDieselRow {
    pub id: Uuid,
    pub org_id: Uuid,
    pub project_id: Option<Uuid>,
    pub name: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = mtls_client_certs)]
pub struct MtlsClientCertsDieselInsert {
    pub id: Option<Uuid>,
    pub org_id: Option<Uuid>,
    pub project_id: Option<Uuid>,
    pub name: Option<String>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = customer_preferences)]
pub struct CustomerPreferencesDieselRow {
    pub user_id: Uuid,
    pub density: String,
    pub timezone: String,
    pub region: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = customer_preferences)]
pub struct CustomerPreferencesDieselInsert {
    pub user_id: Option<Uuid>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = customer_sessions)]
pub struct CustomerSessionsDieselRow {
    pub id: Uuid,
    pub user_id: Uuid,
    pub device: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = customer_sessions)]
pub struct CustomerSessionsDieselInsert {
    pub id: Option<Uuid>,
    pub user_id: Option<Uuid>,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = audit_log)]
pub struct AuditLogDieselInsert {
    pub id: Option<Uuid>,
    pub org_id: Option<Uuid>,
    pub project_id: Option<Uuid>,
    pub actor_user_id: Option<Uuid>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = customer_notifications)]
pub struct CustomerNotificationsDieselRow {
    pub id: Uuid,
    pub user_id: Uuid,
    pub org_id: Option<Uuid>,
    pub kind: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = customer_notifications)]
pub struct CustomerNotificationsDieselInsert {
    pub id: Option<Uuid>,
    pub user_id: Option<Uuid>,
    pub org_id: Option<Uuid>,
    pub kind: Option<String>,
...
diesel::table! {
    use diesel::sql_types::*;
    sync_idempotency_keys (key) {
        key -> Text,
        request_fingerprint -> Varchar,
        committed_version -> Nullable<Int8>,
        created_at -> Timestamptz,
    }
}

#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = sync_idempotency_keys)]
pub struct SyncIdempotencyKeysDieselRow {
    pub key: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = sync_idempotency_keys)]
pub struct SyncIdempotencyKeysDieselInsert {
    pub key: Option<String>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = transcriptions)]
pub struct TranscriptionsDieselRow {
    pub id: Uuid,
    pub source: String,
    pub provider: String,
    pub model: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = transcriptions)]
pub struct TranscriptionsDieselInsert {
    pub id: Option<Uuid>,
    pub source: Option<String>,
    pub provider: Option<String>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = syntheses)]
pub struct SynthesesDieselRow {
    pub id: Uuid,
    pub text: String,
    pub voice: String,
    pub provider: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = syntheses)]
pub struct SynthesesDieselInsert {
    pub id: Option<Uuid>,
    pub text: Option<String>,
...
pub struct TranslationsDieselRow {
    pub id: Uuid,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = translations)]
pub struct TranslationsDieselInsert {
    pub id: Option<Uuid>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = vapi_calls)]
pub struct VapiCallsDieselRow {
    pub id: Uuid,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = vapi_calls)]
pub struct VapiCallsDieselInsert {
    pub id: Option<Uuid>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = vapi_events)]
pub struct VapiEventsDieselRow {
    pub id: Uuid,
    pub vapi_call_id: Option<String>,
    pub event_type: String,
    pub payload: Value,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = vapi_events)]
pub struct VapiEventsDieselInsert {
    pub id: Option<Uuid>,
    pub vapi_call_id: Option<String>,
    pub event_type: Option<String>,
    pub payload: Option<Value>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = fab_plans)]
pub struct FabPlansDieselRow {
    pub id: Uuid,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = fab_plans)]
pub struct FabPlansDieselInsert {
    pub id: Option<Uuid>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = fab_designs)]
pub struct FabDesignsDieselRow {
    pub id: Uuid,
    pub plan_id: Uuid,
    pub filename: String,
    pub format: String,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = fab_designs)]
pub struct FabDesignsDieselInsert {
    pub id: Option<Uuid>,
...
diesel::table! {
    ...
    fab_instructions (id) {
        ...
        validated -> Bool,
        validation -> Jsonb,
        released_by_email -> Nullable<Text>,
...
#[derive(Clone, Debug, Queryable, Selectable, Serialize, Deserialize)]
#[diesel(table_name = fab_instructions)]
pub struct FabInstructionsDieselRow {
    pub id: Uuid,
    pub plan_id: Uuid,
    pub revision: i32,
...
#[derive(Clone, Debug, Insertable, AsChangeset, Serialize, Deserialize)]
#[diesel(table_name = fab_instructions)]
pub struct FabInstructionsDieselInsert {
    pub id: Option<Uuid>,
    pub plan_id: Option<Uuid>,
