...
| `remote/deployments/push-notification-server.rs` | [fanwaave/push-notification-server.rs](https://github.com/fanwaave/push-notification-server.rs) | `main` | `~/codes/fanwaave/push-notification-server.rs` |
