...
def require_tree_entries(payload: Mapping[str, Any], identity: str) -> Sequence[Mapping[str, Any]]:
...
def run_git(command: Sequence[str], *, cwd: Path | None = None) -> subprocess.CompletedProcess[str]:
    try:
