...
export BRIDGE_BASE_URL=http://127.0.0.1:8142
export COORDINATOR_BASE_URL=http://127.0.0.1:8160
export SLACK_SIGNING_SECRET="$SIGNING_TEST_SECRET"
export SLACK_BRIDGE_BEARER="$BRIDGE_TEST_TOKEN"
export SLACK_COORDINATOR_BEARER="$COORDINATOR_TEST_TOKEN"
...
node --test ui/slack-agent-command-security.playwright.test.mjs 2>&1 \
  | tee -a "$RESULT_DIR/playwright.tap"
