...
SLACK_TEST_APP_ID="${SLACK_TEST_APP_ID:-A0BMBAMM5NJ}"
SLACK_TEST_TEAM_ID="${SLACK_TEST_TEAM_ID:-T01B3C83PMK}"
...
start_process slack-command \
  env \
    ...
    SLACK_EXPECTED_APP_ID="$SLACK_TEST_APP_ID" \
    SLACK_EXPECTED_TEAM_ID="$SLACK_TEST_TEAM_ID" \
