...
//! services can resolve a stable OreSoftware user id without a Supabase
//! round-trip. It is a *mirror of identity*, never of credentials: no passwords,
//! no Supabase service-role data.
//!
