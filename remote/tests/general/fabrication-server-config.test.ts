...
test('rust fabrication server exposes planning, analysis, nats, and learning hooks', async () => {
  ...
  assert.match(
    readme,
    /accepted instruction\s+kinds including slicer, SLA\/resin, composite-fiber, binder-jet, SLS\/powder, metal-PBF, laser\/waterjet\/plasma,\s+wire-EDM, and sinker-EDM job sheets/,
  );
  ...
  assert.match(
    readme,
    /slicer, SLA\/resin, composite-fiber, binder-jet, SLS\/powder, metal-PBF, laser\/waterjet\/plasma,\s+wire-EDM, and sinker-EDM job sheets/,
  );
  assert.match(
    readme,
  ...
  assert.match(readme, /SLA resin printer, continuous-fiber composite printer, SLS powder-bed printer/);
