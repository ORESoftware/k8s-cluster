...
test('rust fabrication server exposes planning, analysis, nats, and learning hooks', async () => {
  ...
  assert.match(
    readme,
    /accepted instruction\s+kinds including slicer, pellet-FGF, SLA\/resin,\s+material-jetting, DED\/WAAM, composite-fiber, binder-jet, SLS\/powder, metal-PBF,\s+mill-turn, indexed-mill, assembly-cell, part-separation, laser\/waterjet\/plasma,\s+wire-EDM, and sinker-EDM job sheets/,
  );
  ...
  assert.match(
    readme,
    /slicer, pellet-FGF, SLA\/resin,\s+material-jetting, DED\/WAAM, composite-fiber, binder-jet, SLS\/powder, metal-PBF,\s+mill-turn, indexed-mill, assembly-cell, part-separation, laser\/waterjet\/plasma,\s+wire-EDM, and sinker-EDM job sheets/,
  );
  assert.match(
    readme,
