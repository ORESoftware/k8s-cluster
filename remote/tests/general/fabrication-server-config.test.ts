...
test('rust fabrication server exposes planning, analysis, nats, and learning hooks', async () => {
  ...
  assert.match(
    readme,
    /accepted instruction\s+kinds including slicer, pellet-FGF, paste\/clay extrusion, SLA\/resin,\s+material-jetting, DED\/WAAM, composite-fiber, binder-jet, SLS\/powder, metal-PBF,\s+mill-turn, lathe\/turning, indexed-mill, assembly-cell, part-separation, laser\/waterjet\/plasma,\s+wire-EDM, and sinker-EDM job sheets/,
  );
  ...
  assert.match(
    readme,
    /slicer, pellet-FGF, paste\/clay extrusion, SLA\/resin,\s+material-jetting, DED\/WAAM, composite-fiber, binder-jet, SLS\/powder, metal-PBF,\s+mill-turn, lathe\/turning, indexed-mill, assembly-cell, part-separation, laser\/waterjet\/plasma,\s+wire-EDM, and sinker-EDM job sheets/,
  );
  assert.match(
    readme,
  ...
  assert.match(readme, /SLA resin printer, paste\/clay extrusion printer, material-jetting printer, continuous-fiber composite printer, SLS powder-bed printer, DED\/WAAM directed-energy deposition cell/);
