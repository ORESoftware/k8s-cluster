...
test('rust fabrication server exposes planning, analysis, nats, and learning hooks', async () => {
  ...
  assert.match(
    readme,
    /accepted instruction\s+kinds including slicer, SLA\/resin, material-jetting, DED\/WAAM, composite-fiber, binder-jet, SLS\/powder, metal-PBF, laser\/waterjet\/plasma,\s+wire-EDM, and sinker-EDM job sheets/,
  );
  ...
  assert.match(
    readme,
    /slicer, SLA\/resin, material-jetting, DED\/WAAM, composite-fiber, binder-jet, SLS\/powder, metal-PBF, laser\/waterjet\/plasma,\s+wire-EDM, and sinker-EDM job sheets/,
  );
  assert.match(
    readme,
