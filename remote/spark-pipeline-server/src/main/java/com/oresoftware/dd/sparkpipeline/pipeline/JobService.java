...
public final class JobService {
  ...
  public JobService(final Vertx vertx) {
    this.vertx = vertx;
    ...
    log.info("JobService initialized with maxConcurrent={}", maxConcurrent);
  }
  ...
  // --- SPARK_SUBMIT: Parallel(precheck-cluster, precheck-jar, precheck-config) then submit ---
