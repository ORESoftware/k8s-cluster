...
@Entity
@Table(name = "benefactor_marketing_outreach_sequences")
public class BenefactorMarketingOutreachSequencesEntity {
    @Id
    @Column(name = "id")
    private UUID id;
    ...
    @Column(name = "cadence", nullable = false, columnDefinition = "jsonb")
