...
-record(presence_events, {seq, event_at, op, conv_id, user_id, conv_shard, user_shard, soft_deleted}).
...
presence_events_attributes() -> ['seq', 'event_at', 'op', 'conv_id', 'user_id', 'conv_shard', 'user_shard', 'soft_deleted'].

presence_events_record_info() ->
    {presence_events, 8, presence_events_attributes()}.
