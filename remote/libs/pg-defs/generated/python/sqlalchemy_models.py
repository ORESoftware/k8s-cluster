...
SoundRecorderCloudConnectionsStatus = Literal["active", "paused", "revoked", "error"]
...
class SoundRecorderCloudConnections(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("status in ('active', 'paused', 'revoked', 'error')", name="sound_recorder_cloud_connections_status_chk"),
