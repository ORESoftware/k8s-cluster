...
//// `dd-gleamlang-server` (the WebSocket fan-out service). Reads against
//// `app_config` from this server must always go through the canonical
//// re-export so the schema source-of-truth stays single, and this test
