...
nerdctl -n k8s.io build -f remote/deployments/gleam-lambda-runner/runtime-images/browser.Dockerfile -t docker.io/library/dd-lambda-browser-runtime:dev remote/deployments/gleam-lambda-runner
```
