# `remote/deployments/idle-reaper-rs`
...
| `WORKER_IMAGE_BUILD_REPO_URL` | yes, when enabled | — |
...
health, then make a narrow repo change and rely on `remote/deployments/dev-server` to push
