...
Future<void> main(List<String> args) async {
  ...
  if (mdpEnabled) {
    ...
    metrics
      ...
      ..registerGauge('dart_pool_max_hosts_pod',
          () => poolMaxHostsPerShard * shards.where((s) => !s.dead).length);
    if (autotuner != null) {
      metrics
    ...
    Future<void> mdpTick() async {
      ...
      if (mdpShieldEnabled) {
        final shielded = shieldPoolDirective(
          ...
          maxTotalHosts: poolMaxHostsPerShard * liveShards.length,
    ...
    print(jsonEncode({
      ...
      'max_host_isolates_pod': poolMaxHostsPerShard * gatewayShards,
