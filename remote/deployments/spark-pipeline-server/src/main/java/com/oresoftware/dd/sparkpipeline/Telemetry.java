...
/**
 * Explicit OpenTelemetry SDK wiring for dd-spark-pipeline-server.
 *
 ...
 *       {@code dd-spark-pipeline-server}.</li>
...
public final class Telemetry implements AutoCloseable {
  ...
  public static Telemetry init() {
    ...
    final String serviceName = envOrDefault("OTEL_SERVICE_NAME", "dd-spark-pipeline-server");
