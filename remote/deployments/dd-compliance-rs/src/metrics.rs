...
pub struct Metrics {
    ...
    pub data_viz_render_failures_total: Counter,
...
impl Metrics {
    pub fn render_prometheus(&self) -> String {
        let values = [
            ...
            (
                "dd_compliance_data_viz_render_failures_total",
                "Failed dd-data-viz-rs render attempts.",
                self.data_viz_render_failures_total.get(),
            ),
            (
