    ...
    fn additive_analysis_requires_explicit_extrusion_mode_and_reset() {
        let programs = vec![
            program(
                ...
                "fdm-printer",
                &[
                    "G21 G90 ; filament lot and dry-storage evidence verified",
                    "G28",
                    "M104 S210",
                    "M109 S210",
                    "M140 S60",
            ...
            program(
                ...
                &[
                    "G21 G90",
                    "M82 ; filament lot and dry-storage evidence verified",
                    "G28",
                    "M104 S210",
                    "M109 S210",
                    "M140 S60",
    ...
    fn additive_analysis_requires_filament_lot_and_dry_storage_evidence() {
        let programs = vec![
            ...
            program(
                ...
                &[
                    "G21 G90",
                    "M82 ; filament lot PETG-42 dry-storage, dryer, and desiccant evidence verified",
                    "G28",
                    "M104 S245",
                    "M109 S245",
                    "M140 S75",
    ...
    fn additive_analysis_requires_resume_evidence_after_material_change() {
        let programs = vec![
            program(
                ...
                &[
                    "G21 G90",
                    "M82 ; filament lot PLA-17 dry-storage, dryer, and desiccant evidence verified",
                    "G28",
                    "M104 S215",
                    "M109 S215",
                    "M140 S60",
