...
| `DES_ENGINE_GIT_REF` | `3eb57b8d725968f204cf878b9a621126dff4be37` | *(deployment startup script)* branch/tag/sha to clone for the engine |
...
`3eb57b8d725968f204cf878b9a621126dff4be37`, so it does **not** depend on the
