...
pub use dd_pg_defs::{
    ...
    AGENT_REMOTE_DEV_EVENTS_COLUMNS, AGENT_REMOTE_DEV_EVENTS_TABLE, AGENT_REMOTE_DEV_TASKS_COLUMNS,
    AGENT_REMOTE_DEV_TASKS_TABLE, AGENT_REMOTE_DEV_THREADS_COLUMNS, AGENT_REMOTE_DEV_THREADS_TABLE,
    APP_CONFIG_COLUMNS, APP_CONFIG_TABLE, KNOWN_GIT_REPOS_COLUMNS, KNOWN_GIT_REPOS_TABLE,
    LAMBDA_FUNCTIONS_COLUMNS, LAMBDA_FUNCTIONS_TABLE,
};
