...
1. `ai-agent-coordinator-platform` sync wave `-1` creates the tenant and strict
   AppProject from this repository's `dev` branch.
...
- renders the platform bundle and all AWS/GCP/Hetzner cluster roots;
