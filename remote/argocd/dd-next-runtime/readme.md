...
- `/fabrication/`, `/fabrication/healthz`, `/fabrication/metrics`, `/fabrication/docs/api`,
  ...
  `/fabrication/mesh-repair/catalog`, `/fabrication/design/import/catalog`,
  ...
  `/fabrication/quality/catalog`, `POST /fabrication/quality/plan`,
  ...
  `/fabrication/safety/catalog`, `POST /fabrication/setup/plan`,
