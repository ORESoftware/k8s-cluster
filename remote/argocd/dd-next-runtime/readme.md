...
- `/fabrication/`, `/fabrication/healthz`, `/fabrication/metrics`, `/fabrication/docs/api`,
  ...
  `POST /fabrication/machine-code/generate`, `POST /fabrication/toolpaths/plan`,
  ...
  `/fabrication/strategy/catalog`, `POST /fabrication/strategy/recommend`,
  `/fabrication/schedule/catalog`, `POST /fabrication/execution/plan`,
