...
- `dd-otel-collector` uses `kubernetes_sd_configs (role: pod)` for the
  ...
  `/fabrication/slicers/catalog`, `/fabrication/mesh-repair/catalog`,
  ...
  `/fabrication/handoff/catalog`, `/fabrication/subjects/catalog`,
  ...
  `/fabrication/quality/plan`, `/fabrication/quality/result`,
  `/fabrication/interventions/catalog`, `/fabrication/setup/catalog`,
  `/fabrication/tooling/catalog`, `/fabrication/process-recipes/catalog`,
  `/fabrication/kinematics/catalog`, `/fabrication/tolerances/catalog`,
  `/fabrication/safety/catalog`, `/fabrication/setup/plan`,
  ...
  `/fabrication/methods/catalog`, and `/fabrication/strategy/recommend`,
