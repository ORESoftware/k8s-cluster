# INERT HETZNER TEMPLATE: prerequisites may reconcile only after this file is
# promoted into the Hetzner cluster overlay. Controller and scale set remain
# manual until CRD audit, GitHub App, runner group, image, and smoke gates pass.
