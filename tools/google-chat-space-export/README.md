...
The deployment is smoke-tested from GitHub Actions so the public health route and unauthenticated boundary are verified from outside the local execution network.
