...
/// Service: dd-billing-server
pub const billing_connection_events_subject = "dd.remote.billing.connections.events"
...
/// Service: dd-billing-server
pub const billing_ledger_postings_subject = "dd.remote.billing.ledger.postings"
...
/// Service: dd-billing-server
pub const billing_reconciliation_breaks_subject = "dd.remote.billing.reconciliation.breaks"
...
/// Service: dd-billing-server
pub const billing_sync_commands_subject = "dd.remote.billing.commands.sync"
pub const billing_sync_commands_queue_group = "dd-billing-server"
...
/// Service: dd-billing-server
pub const billing_webhook_receipts_subject = "dd.remote.billing.webhooks.receipts"
...
pub const blockchain_bridge_attestations_subject = "dd.remote.blockchain.bridge.attestations"
...
/// Service: dd-contract-service
pub const blockchain_index_events_subject = "dd.remote.blockchain.index.events"
...
/// Service: dd-contract-service
pub const blockchain_mev_alerts_subject = "dd.remote.blockchain.mev.alerts"

/// Shared result fanout receiving every browser-job terminal result.
/// Service: dd-browser-job-runner
pub const browser_job_results_subject = "dd.remote.browser_jobs.results"
...
pub const build_server_events_subject = "dd.remote.build_server.events"
...
/// Service: dd-build-server
pub const build_server_images_subject = "dd.remote.build_server.images"
...
/// Service: dd-build-server
pub const build_server_requests_subject = "dd.remote.build_server.requests"
pub const build_server_requests_queue_group = "dd-build-server"
...
/// Service: dd-build-server
pub const build_server_results_subject = "dd.remote.build_server.results"

/// Per-fault lifecycle events (selected, injected, restored, aborted-by-guard) emitted by the chaos loops.
/// Service: dd-chaos
pub const chaos_events_subject = "dd.remote.chaos.events"
...
/// Service: dd-chaos
pub const chaos_experiments_subject = "dd.remote.chaos.experiments"
...
/// Service: dd-contract-service
pub const contracts_solana_resolve_subject = "dd.remote.contracts.solana.resolve"
pub const contracts_solana_resolve_queue_group = "dd-contract-service"
...
/// Service: dd-contract-service
pub const contracts_solana_settle_subject = "dd.remote.contracts.solana.settle"
pub const contracts_solana_settle_queue_group = "dd-contract-service"
...
/// Service: dd-contract-service
pub const contracts_solana_settlement_results_subject = "dd.remote.contracts.solana.settlement.results"
...
pub const document_convert_requests_subject = "dd.remote.document.convert"
pub const document_convert_requests_queue_group = "dd-document-rs"

/// Document conversion results published after a request completes or fails.
/// Service: dd-document-rs
pub const document_convert_results_subject = "dd.remote.document.results"
...
pub const evolution_events_subject = "dd.remote.evolution.events"
pub const evolution_events_stream = "DD_REMOTE_EVOLUTION"
...
/// Service: dd-evolution-optimizer
pub const evolution_jobs_subject = "dd.remote.evolution.jobs"
pub const evolution_jobs_queue_group = "dd-evolution-optimizer-islands"
pub const evolution_jobs_stream = "DD_REMOTE_EVOLUTION"
...
/// Service: dd-evolution-optimizer
pub const evolution_migrants_subject = "dd.remote.evolution.migrants"
pub const evolution_migrants_stream = "DD_REMOTE_EVOLUTION"
...
/// Service: dd-evolution-optimizer
pub const evolution_results_subject = "dd.remote.evolution.results"
pub const evolution_results_stream = "DD_REMOTE_EVOLUTION"
...
pub const func_approx_fit_requests_subject = "dd.remote.funcapprox.fit.requests"
pub const func_approx_fit_requests_queue_group = "dd-func-approx-rs"
...
/// Service: dd-func-approx-rs
pub const func_approx_fit_results_subject = "dd.remote.funcapprox.fit.results"
...
/// Service: dd-ocr-rs
pub const ocr_requests_subject = "dd.remote.ocr.requests"
pub const ocr_requests_queue_group = "dd-ocr-rs"

/// OCR results published after a request completes or fails.
/// Service: dd-ocr-rs
pub const ocr_results_subject = "dd.remote.ocr.results"
...
/// Service: dd-public-data-server
pub const public_data_ingest_dead_letter_subject = "dd.remote.public_data.ingest.deadletter"
...
pub const quantum_solve_requests_subject = "dd.remote.quantum.solve.requests"
pub const quantum_solve_requests_queue_group = "dd-quantum-compute-rs"
...
/// Service: dd-quantum-compute-rs
pub const quantum_solve_results_subject = "dd.remote.quantum.solve.results"
...
pub const routing_events_stream = "DD_REMOTE_ROUTING"
...
/// Service: dd-routing-server
pub const routing_jobs_subject = "dd.remote.routing.jobs"
pub const routing_jobs_queue_group = "dd-routing-server-workers"
pub const routing_jobs_stream = "DD_REMOTE_ROUTING"
...
/// Service: dd-routing-server
pub const routing_results_subject = "dd.remote.routing.results"
pub const routing_results_stream = "DD_REMOTE_ROUTING"
...
/// Service: dd-gleam-lambda-runner
pub const workflows_events_subject = "dd.remote.workflows.events"
...
/// Service: dd-gleam-lambda-runner
pub const workflows_start_subject = "dd.remote.workflows.start"
pub const workflows_start_queue_group = "dd-gleam-workflow-engine"

/// Per-job lifecycle and progress events emitted by the isolated browser worker.
/// Service: dd-browser-job-runner
pub const browser_job_events_pattern = "dd.remote.browser_jobs.{job_id}.events"
pub const browser_job_events_wildcard = "dd.remote.browser_jobs.*.events"
pub type BrowserJobEventsSubjectParts {
  BrowserJobEventsSubjectParts(
    job_id: String
  )
}
pub fn browser_job_events_subject(job_id job_id: String) -> String {
  "dd.remote.browser_jobs." <> job_id <> ".events"
}

pub fn parse_browser_job_events_subject(subject: String) -> Option(BrowserJobEventsSubjectParts) {
  let pattern_tokens = string.split("dd.remote.browser_jobs.{job_id}.events", on: ".")
  ...
  case list.length(pattern_tokens) == list.length(subject_tokens) {
    ...
    True -> {
      ...
      let job_id = lookup_param(pairs, "{job_id}")
...
/// Service: dd-browser-job-runner
pub const browser_job_result_pattern = "dd.remote.browser_jobs.{job_id}.result"
pub const browser_job_result_wildcard = "dd.remote.browser_jobs.*.result"
pub type BrowserJobResultSubjectParts {
  BrowserJobResultSubjectParts(
    job_id: String
  )
}
pub fn browser_job_result_subject(job_id job_id: String) -> String {
  "dd.remote.browser_jobs." <> job_id <> ".result"
}

pub fn parse_browser_job_result_subject(subject: String) -> Option(BrowserJobResultSubjectParts) {
  let pattern_tokens = string.split("dd.remote.browser_jobs.{job_id}.result", on: ".")
  let subject_tokens = string.split(subject, on: ".")
  case list.length(pattern_tokens) == list.length(subject_tokens) {
    False -> None
    True -> {
...
/// Service: dd-gleam-lambda-runner
pub const workflows_signal_pattern = "dd.remote.workflows.signal.{run_id}"
pub const workflows_signal_wildcard = "dd.remote.workflows.signal.*"
pub const workflows_signal_queue_group = "dd-gleam-workflow-engine"
pub type WorkflowsSignalSubjectParts {
  WorkflowsSignalSubjectParts(
    run_id: String
  )
}
pub fn workflows_signal_subject(run_id run_id: String) -> String {
  "dd.remote.workflows.signal." <> run_id
}

pub fn parse_workflows_signal_subject(subject: String) -> Option(WorkflowsSignalSubjectParts) {
  let pattern_tokens = string.split("dd.remote.workflows.signal.{run_id}", on: ".")
  let subject_tokens = string.split(subject, on: ".")
  case list.length(pattern_tokens) == list.length(subject_tokens) {
    False -> None
    True -> {
      let pairs = list.zip(pattern_tokens, subject_tokens)
      let run_id = lookup_param(pairs, "{run_id}")
      let literals_ok = list.all(pairs, fn(pair) {
        let #(p, s) = pair
        case string.starts_with(p, "{") && string.ends_with(p, "}") {
          True -> True
...
/// Service: dd-build-server
pub const build_server_queue_group = "dd-build-server"
...
/// Service: dd-document-rs
pub const document_converters_queue_group = "dd-document-rs"
...
/// Service: dd-func-approx-rs
pub const func_approx_queue_group = "dd-func-approx-rs"
...
/// Service: dd-ocr-rs
pub const ocr_workers_queue_group = "dd-ocr-rs"
...
/// Service: dd-quantum-compute-rs
pub const quantum_queue_group = "dd-quantum-compute-rs"
...
/// Service: dd-gleam-lambda-runner
pub const workflow_engine_queue_group = "dd-gleam-workflow-engine"
...
/// Service: dd-build-server
pub const dd_remote_build_jobs_stream_name = "DD_REMOTE_BUILD_JOBS"
pub fn dd_remote_build_jobs_stream_subjects() -> List(String) {
  ["dd.remote.build_server.requests"]
}
pub const dd_remote_build_jobs_stream_retention = "workqueue"
pub const dd_remote_build_jobs_stream_storage = "file"
pub const dd_remote_build_jobs_stream_ack = "explicit"
...
/// Service: dd-evolution-optimizer
pub const dd_remote_evolution_stream_name = "DD_REMOTE_EVOLUTION"
pub fn dd_remote_evolution_stream_subjects() -> List(String) {
  ["dd.remote.evolution.jobs", "dd.remote.evolution.results", "dd.remote.evolution.migrants", "dd.remote.evolution.events"]
}
pub const dd_remote_evolution_stream_retention = "limits"
pub const dd_remote_evolution_stream_storage = "file"
pub const dd_remote_evolution_stream_ack = "explicit"
...
/// Service: dd-fabrication-server
pub const dd_remote_fabrication_stream_name = "DD_REMOTE_FABRICATION"
pub fn dd_remote_fabrication_stream_subjects() -> List(String) {
  ["dd.remote.fabrication.>"]
}
pub const dd_remote_fabrication_stream_retention = "limits"
pub const dd_remote_fabrication_stream_storage = "file"
pub const dd_remote_fabrication_stream_ack = "explicit"
...
/// Service: dd-routing-server
pub const dd_remote_routing_stream_name = "DD_REMOTE_ROUTING"
pub fn dd_remote_routing_stream_subjects() -> List(String) {
  ["dd.remote.routing.jobs", "dd.remote.routing.results", "dd.remote.routing.events"]
}
pub const dd_remote_routing_stream_retention = "limits"
