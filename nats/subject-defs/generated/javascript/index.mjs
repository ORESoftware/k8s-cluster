...
export function browserJobEventsSubject(jobId) {
  return `dd.remote.browser_jobs.${jobId}.events`;
}
export function parseBrowserJobEventsSubject(subject) {
...
export function browserJobResultSubject(jobId) {
  return `dd.remote.browser_jobs.${jobId}.result`;
}
export function parseBrowserJobResultSubject(subject) {
...
export function workflowsSignalSubject(runId) {
  return `dd.remote.workflows.signal.${runId}`;
}
export function parseWorkflowsSignalSubject(subject) {
...
export const DD_REMOTE_EVOLUTION_STREAM_SUBJECTS = Object.freeze(["dd.remote.evolution.jobs","dd.remote.evolution.results","dd.remote.evolution.migrants","dd.remote.evolution.events"]);
...
export const DD_REMOTE_ROUTING_STREAM_SUBJECTS = Object.freeze(["dd.remote.routing.jobs","dd.remote.routing.results","dd.remote.routing.events"]);
...
export const DD_REMOTE_TASKS_DLQ_STREAM_SUBJECTS = Object.freeze(["dd.remote.thread.tasks.deadletter"]);
