{
  description = "shared-auth monorepo orchestration environment";
      ...
      devShells = eachSystem (system:
        ...
        in {
          default = pkgs.mkShell {
            packages = (with pkgs; [ git nodejs_22 rustc cargo jq ]) ++ [ self.packages.${system}.flags2env ];
            RUST_BACKTRACE = "1";
            shellHook = ''
              echo "shared-auth monorepo orchestration environment"
