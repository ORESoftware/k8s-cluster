...
Git superproject for the [scintilla-run](https://github.com/scintilla-run) application repositories,
...
This repo is private: it is the all-up integration view of the Scintilla fleet.

## Clone

```sh
git clone --recurse-submodules git@github.com:scintilla-run/scintilla-monorepo.git
```

## Apps

- [`apps/gleam-lambda-runner`](https://github.com/scintilla-run/gleam-lambda-runner)
